...
const LectorSettings = parent => {
  ...
  let colorsComp = _pragmajs.Select.color("markercolor", colors).bind("c");

  let fontComp = _pragmajs.Select.font("readerfont", fonts).bind("f").html.class("font-selector"); // TODO
