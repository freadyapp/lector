...
},{"./pragmas/helper.js":10,"./pragmas/lector.js":11}],10:[function(require,module,exports){
"use strict";
...
},{"../composers/greek":7,"compromise":3,"jquery":4}],11:[function(require,module,exports){
"use strict";
...
},{"./helper.js":10,"./mark.js":12,"./settings":13,"./word.js":14,"jquery":4,"mousetrap":5,"pragmajs":6}],12:[function(require,module,exports){
"use strict";
...
const LectorSettings = parent => {
  ...
  let colorsComp = (0, _pragmajs.ColorSelect)("markercolors", colors, (v, comp, key) => {
    parent.mark.element.css({
      "background": colors[comp.find(key).value]
    });
  });
  let fontComp = (0, _pragmajs.FontSelect)("readerfont", fonts, (v, comp, key) => {
    (0, _jquery.default)("w").css({
      "font-family": fonts[comp.find(key).value]
    });
  });
  let modeComp = (0, _pragmajs.AttrSelect)("markermode", modes, (v, comp, key) => {
    // on set
    console.log(v);
  }, (key, index) => {
    // icon
...
},{"../composers/settings_builder":8,"animejs":2,"jquery":4,"pragmajs":6}],14:[function(require,module,exports){
"use strict";
