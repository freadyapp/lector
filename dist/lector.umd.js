    ...
    let inf = P("infinity paginator")
          ...
          .run(function(){
            ...
            this.fill = function(){
              ...
              let pagesToRender = v.aryDiff(pageRange, pagesRendered);
              let pagesToDelete = v.aryDiff(pagesRendered, pageRange);
