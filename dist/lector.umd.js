  ...
  function paginator(pageTemplate, conf={}){
    return new K()
          .from(F.create.template.config({
            ...
            onPageRender: typeof conf.onPageRender === 'function' ? conf.onPageRender : function(page, i){ M.log('rendered', page, 'active?', page.active); },
