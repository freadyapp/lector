...
`;
  ...
  const Lector = (l, options=default_options) => {
    ...
    if (!options.experimental) O.throwSoft('EXPERIMENTAL FEATURES TURNED OFF');
    let lector;
