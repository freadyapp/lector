...
`;
  ...
  function monitor(conf={}){
    return new N()
            .from(E.createTemplate(E.objDiff({
                template: v => v,
              }, conf)))
            .do(function() {
