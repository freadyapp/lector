(function (global, factory) {
  ...
  */
  ...
  const LectorSettings = (parent) => {
    ...
    let colorsComp = B('markercolor')
                    .from(V.select({
                      options: colors
                    }));

    let fontComp = B('readerfont')
                    .from(V.select({
                      options: fonts
                    }));
    ...
    let popUpSettings = B("popupsettings")
    ...
    let settings = B("settingsWrapper").contain(popUpSettings, wpmComp)
    ...
    let inf = B("infinity paginator")
          ...
          findActivePages(){
            ...
            this.findActivePage = function(s, dp){
              ...
              return new PinkyPromise(resolve => {
                let canditates;
                M.bench(_ => canditates = findCandidates(this.pages, s));
                //resolve(canditates)
