...
function lectorSettings(lector){
  ...
  let wpmPlus = pragmajs._p('wpmPlusPragma').as(_e('div.wpm-icon', '+'));
  ...
  let wpmComp = pragmajs._p().contain(wpmIcon, setWpm, wpmPlus)
