...
function lectorSettings(lector){
  ...
  let colorIcon = pragmajs._p().as(_e(icons['color-icon'])).css('width 30px; height 30px;')
                  .addClass(`setting-icon`);
  ...
  let wpmMinus = pragmajs._p('wpmMinusPragma').as(_e('div.wpm-icon', '-'));
  ...
  let wpmComp = pragmajs._p().contain(wpmMinus, setWpm, wpmPlus)
